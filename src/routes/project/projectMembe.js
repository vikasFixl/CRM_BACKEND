...
import { assignMember, getAllProjectMembers, RemoveProjectMember, UpdateProjectMember } from "../../controllers/project/projectMember.controller.js";
...
ProjectMemberRouter.route("/:memberId").delete(isAuthenticated, authenticateOrgToken(), RemoveProjectMember);
