...
import { createCandidate, deleteCandidate, getCandidate, getCandidates, getCandidatesList, moveCandidateToInterviewStage, moveToHired, moveToOffer, updateCandidate, updateCandidateStatus } from "../../../controllers/NHRM/Recruitment/CandidateController.js"
...
CandidateRouter.route("/move-to-interview/:candidateId").post(isAuthenticated,authenticateOrgToken(),moveCandidateToInterviewStage)
CandidateRouter.route("/move-to-offer/:candidateId").post(isAuthenticated,authenticateOrgToken(),moveToOffer)
CandidateRouter.route("/move-to-hire/:candidateId").post(isAuthenticated,authenticateOrgToken(),moveToHired)
